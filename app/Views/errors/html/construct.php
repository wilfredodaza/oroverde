...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/css/page-maintenance.css">
    <!-- END: Custom CSS-->
    <!-- END: Custom CSS-->
</head>
<!-- END: Head-->

<body class="vertical-layout page-header-light vertical-menu-collapsible vertical-menu-nav-dark preload-transitions 1-column    blank-page blank-page" data-open="click" data-menu="vertical-menu-nav-dark" data-col="1-column">
<div class="row">
    <div class="col s12">
        <div class="container">
            <div class="section p-0 m-0 height-100vh section-maintenance">
                <div class="row">
                    ...
                    <div id="maintenance" class="col s12 center-align white">
                        <img src="<?= base_url() ?>/assets/img/maintenance.png" class="responsive-img maintenance-img" alt="">
                        <h4 class="error-code">Esta página está en mantenimiento.</h4>
                        <h6 class="mb-2 mt-2">
                            Disculpe las molestias. <br>
                            Por favor, vuelva más tarde.</h6>
                        <a class="btn waves-effect waves-light" href="/home">Regresar al Home</a>
                    </div>
                </div>
            </div>
        </div>
