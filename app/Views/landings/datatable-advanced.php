...
<html
  ...
  <head>
    ...
    <title>DataTables - Advanced Tables | Materialize - Material Design HTML Admin Template</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- Column Search -->
              <div class="card">
                <h5 class="card-header text-center text-md-start">Column Search</h5>
                <div class="card-datatable text-nowrap">
              ...
              <div class="card">
                <h5 class="card-header text-center text-md-start">Responsive Datatable</h5>
                <div class="card-datatable table-responsive">
