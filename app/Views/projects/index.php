    ...
    <div class="row g-6">
        <div class="col-lg-12 mt-0">
            <div class="card">
                ...
                <div class="card-body red d-flex justify-content-between flex-wrap gap-4 p-0" id="indicadores"></div>
            </div>
        </div>
...
<?= $this->section('javaScripts') ?>
    ...
    <script src="<?= base_url(['master/js/projects/index.js?v='.getCommit()]) ?>"></script>
